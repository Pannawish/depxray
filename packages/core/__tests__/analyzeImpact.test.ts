...
describe('analyzeImpact', () => {
  it('finds direct and transitive dependents for a target file', () => {
    ...
    const graph: DependencyGraph = {
      ...
      edges: [
        { source: button.id, target: shared.id, importSpecifier: './shared', importedNames: [], isTypeOnly: false, isDynamic: false },
        { source: test.id, target: shared.id, importSpecifier: './shared', importedNames: [], isTypeOnly: false, isDynamic: false },
        { source: page.id, target: button.id, importSpecifier: './Button', importedNames: [], isTypeOnly: false, isDynamic: false },
        { source: app.id, target: page.id, importSpecifier: './Page', importedNames: [], isTypeOnly: false, isDynamic: false },
      ],
