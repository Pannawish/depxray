...
describe('findDependencyChain', () => {
  it('finds all shortest chains between connected files', () => {
    ...
    const graph: DependencyGraph = {
      ...
      edges: [
        { source: app.id, target: left.id, importSpecifier: './left', importedNames: [], isTypeOnly: false, isDynamic: false },
        { source: app.id, target: right.id, importSpecifier: './right', importedNames: [], isTypeOnly: false, isDynamic: false },
        { source: left.id, target: helper.id, importSpecifier: './helper', importedNames: [], isTypeOnly: false, isDynamic: false },
        { source: right.id, target: helper.id, importSpecifier: './helper', importedNames: [], isTypeOnly: false, isDynamic: false },
      ],
